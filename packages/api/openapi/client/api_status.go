...
func (r StatusAPIGetStatusRequest) Execute() (*StatusResponse, *http.Response, error) {
...
func (a *StatusAPIService) GetStatusExecute(r StatusAPIGetStatusRequest) (*StatusResponse, *http.Response, error) {
	var (
