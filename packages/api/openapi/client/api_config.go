...
func (r ConfigAPIGetConfigRequest) Execute() (*ConfigResponse, *http.Response, error) {
...
func (a *ConfigAPIService) GetConfigExecute(r ConfigAPIGetConfigRequest) (*ConfigResponse, *http.Response, error) {
	var (
