...
type APIKeyAPICreateAPIKeyRequest struct {
	ctx context.Context
	ApiService *APIKeyAPIService
	createAPIKeyRequest *CreateAPIKeyRequest
}

func (r APIKeyAPICreateAPIKeyRequest) CreateAPIKeyRequest(createAPIKeyRequest CreateAPIKeyRequest) APIKeyAPICreateAPIKeyRequest {
	r.createAPIKeyRequest = &createAPIKeyRequest
	return r
}

func (r APIKeyAPICreateAPIKeyRequest) Execute() (*CreateAPIKeyResponse, *http.Response, error) {
...
Create a new API key
 ...
 @return APIKeyAPICreateAPIKeyRequest
*/
func (a *APIKeyAPIService) CreateAPIKey(ctx context.Context) APIKeyAPICreateAPIKeyRequest {
	return APIKeyAPICreateAPIKeyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *APIKeyAPIService) CreateAPIKeyExecute(r APIKeyAPICreateAPIKeyRequest) (*CreateAPIKeyResponse, *http.Response, error) {
	var (
...
type APIKeyAPIDeleteAPIKeyRequest struct {
	ctx context.Context
	ApiService *APIKeyAPIService
	id int64
}

func (r APIKeyAPIDeleteAPIKeyRequest) Execute() (*http.Response, error) {
...
Delete an API key
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id API Key ID
 @return APIKeyAPIDeleteAPIKeyRequest
*/
func (a *APIKeyAPIService) DeleteAPIKey(ctx context.Context, id int64) APIKeyAPIDeleteAPIKeyRequest {
	return APIKeyAPIDeleteAPIKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *APIKeyAPIService) DeleteAPIKeyExecute(r APIKeyAPIDeleteAPIKeyRequest) (*http.Response, error) {
	var (
...
type APIKeyAPIGetAPIKeysRequest struct {
	ctx context.Context
	ApiService *APIKeyAPIService
	pageSize *int32
	pageIndex *int32
...
func (r APIKeyAPIGetAPIKeysRequest) PageSize(pageSize int32) APIKeyAPIGetAPIKeysRequest {
	r.pageSize = &pageSize
	return r
}

// Page index, starting from 1 (default 1)
func (r APIKeyAPIGetAPIKeysRequest) PageIndex(pageIndex int32) APIKeyAPIGetAPIKeysRequest {
	r.pageIndex = &pageIndex
	return r
}

func (r APIKeyAPIGetAPIKeysRequest) Execute() (*APIKeysResponse, *http.Response, error) {
...
Get API keys for the current user with pagination
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return APIKeyAPIGetAPIKeysRequest
*/
func (a *APIKeyAPIService) GetAPIKeys(ctx context.Context) APIKeyAPIGetAPIKeysRequest {
	return APIKeyAPIGetAPIKeysRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *APIKeyAPIService) GetAPIKeysExecute(r APIKeyAPIGetAPIKeysRequest) (*APIKeysResponse, *http.Response, error) {
	var (
...
type APIKeyAPIUpdateAPIKeyRequest struct {
	ctx context.Context
	ApiService *APIKeyAPIService
	id int64
...
func (r APIKeyAPIUpdateAPIKeyRequest) UpdateAPIKeyRequest(updateAPIKeyRequest UpdateAPIKeyRequest) APIKeyAPIUpdateAPIKeyRequest {
	r.updateAPIKeyRequest = &updateAPIKeyRequest
	return r
}

func (r APIKeyAPIUpdateAPIKeyRequest) Execute() (*VaultAPIKey, *http.Response, error) {
...
Update an API key (enable/disable or modify properties)
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id API Key ID
 @return APIKeyAPIUpdateAPIKeyRequest
*/
func (a *APIKeyAPIService) UpdateAPIKey(ctx context.Context, id int64) APIKeyAPIUpdateAPIKeyRequest {
	return APIKeyAPIUpdateAPIKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return VaultAPIKey
func (a *APIKeyAPIService) UpdateAPIKeyExecute(r APIKeyAPIUpdateAPIKeyRequest) (*VaultAPIKey, *http.Response, error) {
	var (
