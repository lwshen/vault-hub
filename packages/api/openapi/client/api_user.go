...
func (r UserAPIGetCurrentUserRequest) Execute() (*GetUserResponse, *http.Response, error) {
...
func (a *UserAPIService) GetCurrentUserExecute(r UserAPIGetCurrentUserRequest) (*GetUserResponse, *http.Response, error) {
	var (
