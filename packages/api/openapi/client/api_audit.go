...
type AuditAPIGetAuditLogsRequest struct {
	ctx context.Context
...
func (r AuditAPIGetAuditLogsRequest) PageSize(pageSize int32) AuditAPIGetAuditLogsRequest {
	r.pageSize = &pageSize
	return r
}

// Page index, starting from 0 (default 0)
func (r AuditAPIGetAuditLogsRequest) PageIndex(pageIndex int32) AuditAPIGetAuditLogsRequest {
	r.pageIndex = &pageIndex
	return r
}

// Filter logs from this date (ISO 8601 format)
func (r AuditAPIGetAuditLogsRequest) StartDate(startDate time.Time) AuditAPIGetAuditLogsRequest {
	r.startDate = &startDate
	return r
}

// Filter logs until this date (ISO 8601 format)
func (r AuditAPIGetAuditLogsRequest) EndDate(endDate time.Time) AuditAPIGetAuditLogsRequest {
	r.endDate = &endDate
	return r
}

// Filter logs by vault unique ID
func (r AuditAPIGetAuditLogsRequest) VaultUniqueId(vaultUniqueId string) AuditAPIGetAuditLogsRequest {
	r.vaultUniqueId = &vaultUniqueId
	return r
}

func (r AuditAPIGetAuditLogsRequest) Execute() (*AuditLogsResponse, *http.Response, error) {
...
Get audit logs with optional filtering and pagination
 ...
 @return AuditAPIGetAuditLogsRequest
*/
func (a *AuditAPIService) GetAuditLogs(ctx context.Context) AuditAPIGetAuditLogsRequest {
	return AuditAPIGetAuditLogsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AuditAPIService) GetAuditLogsExecute(r AuditAPIGetAuditLogsRequest) (*AuditLogsResponse, *http.Response, error) {
	var (
	...
	if r.vaultUniqueId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "vaultUniqueId", r.vaultUniqueId, "form", "")
	}
...
type AuditAPIGetAuditMetricsRequest struct {
	ctx context.Context
	ApiService *AuditAPIService
}

func (r AuditAPIGetAuditMetricsRequest) Execute() (*AuditMetricsResponse, *http.Response, error) {
...
Get audit log metrics including total events and categorized counts
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return AuditAPIGetAuditMetricsRequest
*/
func (a *AuditAPIService) GetAuditMetrics(ctx context.Context) AuditAPIGetAuditMetricsRequest {
	return AuditAPIGetAuditMetricsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AuditAPIService) GetAuditMetricsExecute(r AuditAPIGetAuditMetricsRequest) (*AuditMetricsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
